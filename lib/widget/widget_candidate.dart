...
class CanWidget extends StatefulWidget {
  VoidCallback tap;
  String text;
  int index;
  double width;
  ...
  CanWidget({this.tap, this.index, this.width, this.text, this.answerState});
  _CanWidgetState createState() => _CanWidgetState();
}

class _CanWidgetState extends State<CanWidget> {
  @override
